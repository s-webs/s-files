...
<div data-file-manager class="h-full relative">
        ...
        <div class="p-4 rounded-xl shadow-2xl backdrop-blur-sm border">
            <div class="flex items-center justify-between">
                <div class="flex items-center space-x-3">
                    <i class="text-xl" data-notification-icon></i>
                    <p class="font-medium" data-notification-message></p>
                </div>
                <button data-notification-close
    ...
    <div data-operation-loading
        ...
        <div class="bg-white/95 backdrop-blur-md p-8 rounded-2xl shadow-2xl border border-gray-200">
            <div class="flex flex-col items-center space-y-4">
                ...
                <span class="text-lg font-semibold text-gray-700" data-operation-loading-text>{{ __('sfiles::sfiles.operation_loading') }}</span>
            </div>
        </div>
    </div>
    ...
    <div data-drag-over
        ...
        <div class="text-center transform animate-pulse">
            ...
            <p class="text-3xl font-bold text-blue-800 drop-shadow-md" data-drag-over-text>{{ __('sfiles::sfiles.drag_drop_here') }}</p>
            <p class="text-lg text-blue-600 mt-2" data-drag-over-release-text>{{ __('sfiles::sfiles.drag_drop_release') }}</p>
        </div>
    </div>
